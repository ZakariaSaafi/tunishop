...
@Data
@NoArgsConstructor
public class VerificationTokenVendeur {
	...
	//expiration time 10min
		...
		nullable=false,
		foreignKey=@ForeignKey(name="FK_VENDEUR_VERIFY_TOKEN"))
		private Vendeur vend;
		
		public VerificationTokenVendeur() {};
		
		
		public VerificationTokenVendeur(Vendeur user,String token) {
			super();
			this.token=token;
			this.vend=user;
