...
@Component({
  selector: 'app-list-habillement',
  templateUrl: './list-habillement.component.html',
  styleUrls: ['./list-habillement.component.css']
})
export class ListHabillementComponent implements OnInit {
  ...
  constructor(private categorieService:CategorieService,private produitService:ProduitServiceService,private router:Router, private route: ActivatedRoute,
