...
@Component({
  selector: 'app-list-immobilier',
  templateUrl: './list-immobilier.component.html',
  styleUrls: ['./list-immobilier.component.css']
})
export class ListImmobilierComponent implements OnInit {
