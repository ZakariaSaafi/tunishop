...
@Component({
  selector: 'app-list-loisir-diver',
  templateUrl: './list-loisir-diver.component.html',
  styleUrls: ['./list-loisir-diver.component.css']
})
export class ListLoisirDiverComponent implements OnInit {
