...
@Component({
  selector: 'app-list-view-habillement',
  templateUrl: './list-view-habillement.component.html',
  styleUrls: ['./list-view-habillement.component.css']
})
export class ListViewHabillementComponent implements OnInit {
