...
@Component({
  selector: 'app-list-view-immobilier',
  templateUrl: './list-view-immobilier.component.html',
  styleUrls: ['./list-view-immobilier.component.css']
})
export class ListViewImmobilierComponent implements OnInit {
