...
@Component({
  selector: 'app-list-view-info-multi',
  templateUrl: './list-view-info-multi.component.html',
  styleUrls: ['./list-view-info-multi.component.css']
})
export class ListViewInfoMultiComponent implements OnInit {
